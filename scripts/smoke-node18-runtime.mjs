...
import { censorRuleFromConfusableObfuscatedTerms } from '../packages/core/dist/confusable-obfuscated.js';
...
assert.equal(confusableEngine.find('motherfuсker')[0]?.targetText, 'fuсk');
