...
The demo's **Sanitized Copy** action follows that contract: it enables copying after source-absence verification succeeds and writes only the generated string to the clipboard.
